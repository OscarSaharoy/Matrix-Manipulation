...
class ButtonsMenu(Frame):
    ...
    def __init__(self, parent, values=[], highlightthickness=2, highlightbackground='grey80',
                 hovercolor='grey80', bg='grey95', width=100, height=100, anchor='w', **kwargs):
        
        # Similarly to the EdgeButton, these keywords will affect only the frame when used.
        self.frame_kw = ['highlightbackground', 'highlightthickness', 'bd', 'relief', 'width',
                         'height']
        
        # Initialising frame
        Frame.__init__(self,parent, highlightthickness=highlightthickness,
    ...
    def _close(self,e):
        ...
        if e.widget not in self.buttons:
            self.place_forget()
...
class Dropdown(EdgeButton):
    ...
    def __init__(self,parent, command=None, width=16, height=1, anchor='w', values=None, default=None,
        ...
        default    = (self['default'] if self['default'] else self['value'])
        self.index = None
        self.set(default)
...
class Scale(Canvas):
    ...
    def __init__(self, parent, height=40, length=200, from_=0, to=100, highlightthickness=0,
                 hovercolor='grey70', fg='grey80', bg='grey50', fill='white', **kwargs):
