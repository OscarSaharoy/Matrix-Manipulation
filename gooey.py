...
class Tk(tkinter.Tk):
    def __init__(self):
        ...
        self.tk_setPalette(background='white', foreground='black', activeBackground='grey80', activeForeground='black', disabledForeground='grey80')
...
class Frame(ReConfig,tkinter.Frame):
    def __init__(self,parent,hovercolor='grey80',state='disabled',highlightbackground='grey90',highlightthickness=4,**kwargs):
        tkinter.Frame.__init__(self,parent,highlightbackground=highlightbackground,highlightthickness=highlightthickness,**kwargs)
...
class Entry(ReConfig,tkinter.Entry):
    def __init__(self,parent,allowed=None,resize=False,hovercolor='grey80',bd=0,bg='white',highlightthickness=4,highlightbackground='grey90',highlightcolor='turquoise3',**kwargs):
        ...
        tkinter.Entry.__init__(self,parent,bd=bd,bg=bg,highlightthickness=highlightthickness,highlightbackground=highlightbackground,highlightcolor=highlightcolor,validate="key", validatecommand=vcmd,**kwargs)
        ReConfig.__init__(self,kw='highlightbackground')
...
class Text(ReConfig,tkinter.Text):
    def __init__(self,parent,allowed=None,resize=False,hovercolor='grey80',wrap='word',bd=0,bg='white',highlightthickness=4,highlightbackground='grey90',highlightcolor='turquoise3',**kwargs):
        vcmd = (parent.register(self.onValidate),'%S')
        tkinter.Text.__init__(self,parent,bd=bd,wrap=wrap,bg=bg,highlightthickness=highlightthickness,highlightbackground=highlightbackground,highlightcolor=highlightcolor,validate="key", validatecommand=vcmd,**kwargs)
        ReConfig.__init__(self,kw='highlightbackground')
        self.gooey_kw = {'allowed':allowed,'resize':resize,'hovercolor':hovercolor,'defaultsize':[self['width'],self['height']]}
    ...
    def resize(self):
        ...
        self.config(width=max(maxline,self.gooey_kw['defaultsize'][0]),height=max(lines,self.gooey_kw['defaultsize'][1]))
...
class OptionMenu(ReConfig,tkinter.OptionMenu):
    ...
    def __init__(self, parent, borderwidth=0,activebackground='white',highlightthickness=4,highlightbackground='grey90',
                 highlightcolor='turquoise3',relief='flat',anchor='w',width=16,hovercolor='grey80',command=None,values=None,**kwargs):
        self.parent = parent
        ...
        tkinter.Widget.__init__(self, parent,"menubutton",cnf,
            {'borderwidth':borderwidth,'relief':relief,'highlightthickness':highlightthickness,'highlightbackground':highlightbackground,
             'highlightcolor':highlightcolor,"anchor": anchor,'width':width,'activebackground':activebackground})
...
class Canvas(ReConfig,tkinter.Canvas):
    def __init__(self,parent,state='active',hovercolor='grey80',bg='white',highlightthickness=4,highlightbackground='grey90',highlightcolor='turquoise3',**kwargs):
        tkinter.Canvas.__init__(self,parent,bg=bg,highlightthickness=highlightthickness,highlightbackground=highlightbackground,highlightcolor=highlightcolor,**kwargs)
        ReConfig.__init__(self,kw='highlightbackground')
...
class EdgeButton(ReConfig,tkinter.Frame):
    ...
    def __init__(self,parent,hovercolor='grey80',state='normal',highlightbackground='grey90',highlightthickness=4,highlightcolor='turquoise3',bd=0,padx=3,pady=3,compound='right',**kwargs):
        tkinter.Frame.__init__(self,parent,highlightbackground=highlightbackground,highlightthickness=highlightthickness,highlightcolor=highlightcolor)
        ReConfig.__init__(self,kw='highlightbackground')
        self.parent   = parent
        self.gooey_kw = {'hovercolor':hovercolor}
        ...
        self._button = Button(self,bd=bd,state=state,hovercolor='white',bg='white',activebackground='grey90',padx=padx,pady=pady,compound=compound,**kwargs)
...
class Combobox(EdgeButton):
    ...
    def __init__(self,parent,command=None,width=16,height=1,anchor='w',values=None,default=None,**kwargs):
        EdgeButton.__init__(self,parent,width=width,height=height,text=values[0],anchor=anchor,command=self._pop_up,**kwargs)
...
class Tooltip(ReConfig,tkinter.Toplevel):
    ...
    def __init__(self,parent,text=None,delayin=400,delayout=100,offset=[1,1],bd=0,highlightthickness=4,highlightbackground='turquoise3',highlightcolor='turquoise3',pady=10,padx=10,**kwargs):
        tkinter.Toplevel.__init__(self,bd=bd,highlightthickness=highlightthickness,highlightbackground=highlightbackground,highlightcolor=highlightcolor,pady=pady,padx=padx,**kwargs)
    ...
    def grid(self, cnf={}, **kwargs):
        ...
        raise GooeyException, 'Tooltip.grid(),Tooltip.pack() and Tooltip.place() are not supported. The tooltip is placed using internal methods automatically on parent widget mouseover.'
    pack = place = grid
...
if __name__ == '__main__':
    ...
    class Test(Tk):
        ...
        def __init__(self):
            ...
            self.selector = Combobox(self.info_frame,values=['Gold','Silver','Oil'],font=segoe_ui_10,command=self.update_data)
